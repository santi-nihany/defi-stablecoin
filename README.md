...
Created a defi stablecoin, enabling users to use wbtc and weth as collaterals.
...
This project is part of the [Cyfrin Advanced Foundry Solidity Course](https://updraft.cyfrin.io/courses/advanced-foundry).
...
```
git clone https://github.com/santi-nihany/defi-stablecoin.git
cd defi-stablecoin
forge build
```
