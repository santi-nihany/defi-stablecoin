...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testRevertsIfTokenLengthDoesntMatchPriceFeeds() public {
        ...
        vm.expectRevert(DSCEngine.TokenAndPriceFeedMustBeSameLength.selector);
    ...
    //     // Act / Assert
    //     vm.expectRevert(DSCEngine.TransferFailed.selector);
    ...
    function testRevertsWithUnapprovedCollateral() public {
        ...
        vm.startPrank(user);
        vm.expectRevert(abi.encodeWithSelector(DSCEngine.NotAllowedToken.selector, address(randToken)));
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(DSCEngine.BreaksHealthFactor.selector, expectedHealthFactor));
    ...
    //     vm.expectRevert(DSCEngine.MintFailed.selector);
    ...
    //     MockV3Aggregator(ethUsdPriceFeed).updateAnswer(ethUsdUpdatedPrice);
    //     // Act/Assert
    //     vm.expectRevert(DSCEngine.HealthFactorNotImproved.selector);
